Parse.Cloud.beforeSave("CircuitUnit", function (request, response) {
    let CircuitUnit = request.object;
    // client pointer has been updated
    if (CircuitUnit.existed() && CircuitUnit.dirty('client')) {
        // and is empty
    ...
    let hasPosition = CircuitUnit.has('clientPosition');
    let clientPointer = CircuitUnit.get('client');
...
//# sourceMappingURL=circuitunit.js.map